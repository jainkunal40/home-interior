...
export function ProjectDetailView({ project, allVendors, allContractors }: { project: any; allVendors?: any[]; allContractors?: any[] }) {
  ...
  const totalExpenses = project.expenseTransactions.reduce((s: number, t: any) => s + t.amount + (t.taxAmount || 0), 0)
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="pb-20 sm:pb-4">
        ...
        {activeTab === 'reports' && <ReportsTab project={project} totalIncome={totalIncome} totalExpenses={totalExpenses} totalLabor={totalLabor} netProfit={netProfit} />}
      </div>
    </div>
  )
}
